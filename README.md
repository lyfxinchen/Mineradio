...
这是经过个性化定制的 Mineradio 沉浸式版本，支持“背景透明常在”、“控制面板亚克力磨砂模糊度调节”以及“全屏鼠标悬停自动淡入控制栏”等功能。

| 下载入口 | 推荐人群 | 链接 |
| --- | --- | --- |
| GitHub Release 下载 | 所有用户 | [v1.1.1 个人定制版 Release](https://github.com/lyfxinchen/Mineradio/releases/tag/v1.1.1) |
