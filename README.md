...
原版项目是一款 Windows 桌面沉浸式音乐播放器，把天气电台、搜索播放、歌词舞台、粒子视觉和 3D 歌单架组合成一个更接近现场感的私人音乐空间。

## 立即下载 Windows 安装包

为了满足不同用户的偏好，在此同时提供“亚克力透明定制版”与“原作者官方正式版”：


| 版本分类                    | 特色与推荐人群                                                                    | 下载链接入口                                                                                                                                  |
| --------------------------- | --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| **亚克力透明定制版** (推荐) | 支持背景透明常在、操作面板手动控制毛玻璃模糊度、全屏/最大化鼠标悬停自动淡入控制栏 | [v1.1.1 个人定制版 Release](https://github.com/lyfxinchen/Mineradio/releases/tag/v1.1.1)                                                      |
| **原作者官方版**            | 官方纯净版（黑底沉浸式氛围）K                                                     | [蓝奏云满速下载](https://xxhuber.lanzout.com/s/Mineradio) / [官方 GitHub Release](https://github.com/XxHuberrr/Mineradio/releases/tag/v1.1.1) |

安装时只需要下载并运行对应版本的 `Mineradio-1.1.1-Setup.exe`。不要下载 `Source code`、`.blockmap`、`latest.yml`，也不要把 `win-unpacked` 当成正式安装包。
...
本项目（个人定制版）由 [LYFxiaoan](https://github.com/lyfxinchen) 在原作者项目基础上进行开发与定制。

原版 Mineradio 由 XxHuberrr 主要设计与打造。emily 作为早期视觉底层想法与 `emily` 视觉预设改进方向的共创者和灵感来源之一，特此感谢。
...
Portions Copyright (C) 2026 LYFxiaoan.

本项目采用 GPL-3.0 授权。详见 [LICENSE](./LICENSE)。

MR Logo、Mineradio 名称、界面视觉设计与原创视觉表达归原作者所有；第三方依赖和第三方服务分别遵循其各自授权与服务条款。根据 GPL-3.0 协议要求，本分支版本的所有修改及发布内容同样以 GPL-3.0 协议开源。
